...
**Read:** `get_game`, `list_leagues`, `get_league`, `list_teams`, `get_team`, `get_standings`, `get_roster`, `get_team_stats`, `get_league_scoreboard`, `get_team_matchup_history`, `get_player_stats`, `list_players`, `rank_players`, `search_players`, `get_league_scoring_categories`, `get_transactions`
